...
int main()
{
	int n, min, max, num_of_iterations;
	std::cout << "input n, min, max, number of iterations: ";
	std::cin >> n >> min >> max >> num_of_iterations;
	...
	printArray(ar, n);
	std::cout << "time: " << average_time_for_iteration << std::endl;
